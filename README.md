...
자연어로 입력한 조건을 바탕으로 맛집을 검색하고, 리뷰 수·평점·가격대를 고려해 맛집을 추천하는 Streamlit 기반 AI Agent입니다. 기본 추천 개수는 3곳이며, 사용자가 “5곳 추천”처럼 개수를 지정하면 해당 개수에 맞춰 추천합니다.
